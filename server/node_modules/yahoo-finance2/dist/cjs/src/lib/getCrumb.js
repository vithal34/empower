...
const cookieJar_js_1 = __importDefault(require("./cookieJar.js"));
let crumb = null;
...
let promise = null;
let promiseTime = 0;
function getCrumbClear() {
    crumb = null;
    promise = null;
    promiseTime = 0;
    cookieJar_js_1.default.removeAllCookiesSync();
}
exports.getCrumbClear = getCrumbClear;
function getCrumb(fetch, fetchOptionsBase, url = "https://finance.yahoo.com/quote/AAPL", __getCrumb = _getCrumb) {
    // TODO, rather do this with cookie expire time somehow
    const now = Date.now();
    if (!promise || now - promiseTime > 60000) {
